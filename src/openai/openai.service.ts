...
export class OpenAiService {
  ...
  private buildSystemPrompt(
    ...
    let prompt =
      ...
      '- Сначала покажи результаты по МИНИМУМУ: город вылета + страна + даты. Ночи и взрослые — подставь дефолты (3-14 ночей, 2 взрослых), не спрашивай заранее.\n' +
      '- После показа результатов юзер может уточнить: "10 ночей", "1 взрослый", "до 100к бюджет" — тогда делай НОВЫЙ поиск с этими параметрами.\n' +
      '- Не выспрашивай всё подряд до первого поиска. Даты + куда + откуда — достаточно для старта.\n\n' +
