...
export class OpenAiService {
  ...
  private buildSystemPrompt(
    ...
    let prompt =
      ...
      '- "chat" — юзер болтает, спрашивает совет, спрашивает ЧТО ТЫ ЗАПОМНИЛ, или уточняет по УЖЕ ПОКАЗАННЫМ результатам ("что ты дал", "что показал", "объясни", "что это") — НЕ ищи туры заново! Ответь по существу, объясни что было показано.\n\n' +
